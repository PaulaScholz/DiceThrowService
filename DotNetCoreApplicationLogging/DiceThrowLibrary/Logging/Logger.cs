...
{
    /// <summary>
    /// Provides the main entry point into the ETW Logging framework, delivering a means to pass diagnostic
    ...
    public static class Logger
    {
        ...
        private static LogEventSource Source
            => LogEventSource.Instance;
