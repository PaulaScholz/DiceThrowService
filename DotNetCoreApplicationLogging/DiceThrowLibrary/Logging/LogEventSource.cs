...
// allow nullable types in this code module
#nullable enable

namespace DiceThrowLibrary.Logging
{
    /// <summary>
    /// Provides a source for diagnostic messages from library DLLs to external listeners.
    /// </summary>
    [EventSource(Name = EVENT_SOURCE_NAME)]
    sealed public class LogEventSource : EventSource
    {
        private const string EVENT_SOURCE_NAME = "DiceThrowLog";
        ...
        /// </summary>
        public static LogEventSource Instance
        { get; } = new LogEventSource();
